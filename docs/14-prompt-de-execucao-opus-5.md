...
**M8 — Produção.** Projeto Supabase + Vercel, envs, domínio, `deploy-db.yml`, Release Please, smoke test em produção, runbook (`docs/runbooks.md`). *DoD: Fase 1+2 do roadmap em produção com 20 vagas reais.*
